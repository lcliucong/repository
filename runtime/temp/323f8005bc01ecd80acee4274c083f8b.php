<?php /*a:2:{s:65:"D:\phpstudy_pro\WWW\tp51t\application\admin\view\admin\index.html";i:1630889525;s:67:"D:\phpstudy_pro\WWW\tp51t\application\admin\view\public\header.html";i:1630630735;}*/ ?>
<!doctype html>
...
<div class="container">
    <div class="logo">
        <a href="./index.html"><i class="layui-icon layui-icon-template" style="font-size: 30px;"></i>   </a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav left fast-add" lay-filter="">
        ...
        <li class="layui-nav-item" id="clear">
        <a href="#"  onclick="clears('obj')">清除缓存</a>
        </li>
    </ul>
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
           <div>
               <a href="javascript:;">
                   <img src="<?php echo htmlentities(app('session')->get('info.head_img')); ?>" alt="头像" style="height: 30px;width: 30px;margin-right: 8px;border-radius: 50%"><?php echo htmlentities(app('session')->get('info.user_name')); ?></a>
           </div>

            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <dd>
                    <a onclick="xadmin.open('个人信息','<?php echo url("admininfo/admininfo"); ?>?id=<?php echo htmlentities(app('session')->get('info.id')); ?>')">个人信息</a>
                </dd>
                <dd>
                    <a onclick="xadmin.open('切换帐号','http://www.baidu.com')">切换帐号</a></dd>
                <dd>
                    <a href="<?php echo url('login/done'); ?>">退出</a>
                </dd>
            </dl>
        </li>
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('文章列表','<?php echo url("Indexshow/indexshow"); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文章列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('暂无数据','<?php echo url("Matchnews/matchnews"); ?>',true)">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>暂无数据</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('暂无数据','<?php echo url("Excellentwork/worklist"); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>暂无数据</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('暂无数据','<?php echo url("Review/reviewer"); ?>')">
                        <i class="iconfont">&#xe6a7;</i>
                        <cite>暂无数据</cite></a>
                    </li>
<!--                    <li>-->
...
<!--                    </li>-->
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('导航栏多级分类','<?php echo url("header/headercate"); ?>')">
                        <i class="iconfont">&#xe6a7;</i>
                        <cite>导航栏多级分类</cite></a>
                    </li>
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('征稿启示','<?php echo url("zgqs/sonlist"); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>征稿启示</cite></a>
                            </li>
                            <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('用户列表','<?php echo url("user/userlist"); ?>')">
                        <i class="iconfont">&#xe6a7;</i>
                        <cite>用户列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('三级地区联动','')">
                        <i class="iconfont">&#xe6a7;</i>
                        <cite>三级地区联动</cite></a>
                    </li>
                </ul>
        ...
        function clears(obj){
          layer.confirm('确定要删除吗?',function (){
              $.ajax({
                  ...
                  url:'clearcha',
                  success:function(){
                    layer.alert('清除成功',{icon:6,time:1500});
                  }
              })
          });
        }
